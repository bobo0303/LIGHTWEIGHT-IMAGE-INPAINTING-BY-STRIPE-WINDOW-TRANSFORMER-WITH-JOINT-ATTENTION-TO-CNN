...
class inpaint_model(nn.Module):
    ...
    def __init__(self, args):
        ...
        '''
        # for XL chanel 128 to 2048
        self.conv_1x1_128to512 = nn.Conv2d(in_channels=128, out_channels=512, kernel_size=1, stride=1, padding=0)
        self.conv_1x1_512to2048 = nn.Conv2d(in_channels=512, out_channels=2048, kernel_size=1, stride=1, padding=0)
        # for XL chanel 2048 to 128
        self.conv_1x1_2048to512 = nn.Conv2d(in_channels=2048, out_channels=512, kernel_size=1, stride=1, padding=0)
        self.conv_1x1_512to128 = nn.Conv2d(in_channels=512, out_channels=128, kernel_size=1, stride=1, padding=0)
        
        # for attn 1x1 2048 to 128
        self.conv_attn_1x1_2048to128 = nn.Conv2d(in_channels=2048, out_channels=128, kernel_size=1, stride=1, padding=0)
        '''
