...
class BlockAxial(AxialAttention):
    ...
    def __init__(self, args):
        super().__init__(args['n_embd'], args['n_head'], args['attn_pdrop'], args['resid_pdrop'], 32, 32)
...
class my_Block_2(nn.Module):
    ...
    def __init__(self, args):
        super().__init__()
        self.ln1 = nn.LayerNorm(args['n_embd'])#LayerNorm
        self.ln2 = nn.LayerNorm(args['n_embd'])#LayerNorm
