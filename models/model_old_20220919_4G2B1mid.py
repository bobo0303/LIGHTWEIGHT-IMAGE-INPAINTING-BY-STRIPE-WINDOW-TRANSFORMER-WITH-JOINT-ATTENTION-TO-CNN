...
class inpaint_model(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.GFF_1x1 = nn.Conv2d(args['nFeat'] * 2, args['nFeat'], kernel_size=1, padding=0, bias=True)  # 因為是 concat兩個RDB而以所以 輸入通道是 *2
